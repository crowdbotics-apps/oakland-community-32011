...
## Project Structure
    ...
    ├── oakland_community_32011  # Django project configurations
...
1. Clone this repo and `cd oakland_community_32011`
...
2. Clone this repo and `cd oakland_community_32011`
